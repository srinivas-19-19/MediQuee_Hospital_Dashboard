      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="bg-surface border border-border rounded-[20px] overflow-hidden">
          ...
          <div className="p-4 flex flex-col gap-2 text-[14px]">
            <div className="flex justify-between"><span className="text-muted">Name</span><span className="font-semibold text-right">{values.account?.name}</span></div>
            <div className="flex justify-between"><span className="text-muted">Email</span><span className="font-semibold text-right">{values.account?.email}</span></div>
            <div className="flex justify-between"><span className="text-muted">Phone</span><span className="font-semibold text-right">{values.account?.phone}</span></div>
          </div>
        </div>
        ...
        <div className="bg-surface border border-border rounded-[20px] overflow-hidden">
          ...
          <div className="p-4 flex flex-col gap-2 text-[14px]">
            <div className="flex justify-between"><span className="text-muted">Name</span><span className="font-semibold text-right">{(entityInfo as any)?.hospitalName || (entityInfo as any)?.labName}</span></div>
            <div className="flex justify-between"><span className="text-muted">Type</span><span className="font-semibold text-right">{(entityInfo as any)?.hospitalType || (entityInfo as any)?.labType}</span></div>
            <div className="flex justify-between"><span className="text-muted">Reg No.</span><span className="font-semibold text-right">{entityInfo?.registrationNumber}</span></div>
          </div>
        </div>
        ...
        <div className="bg-surface border border-border rounded-[20px] overflow-hidden">
          ...
          <div className="p-4 flex flex-col gap-2 text-[14px]">
            <div className="flex justify-between"><span className="text-muted">Address</span><span className="font-semibold text-right line-clamp-2 w-1/2">{entityLocation?.address1}, {entityLocation?.city}</span></div>
            <div className="flex justify-between"><span className="text-muted">Contact</span><span className="font-semibold text-right">{entityLocation?.contactNumber}</span></div>
          </div>
        </div>
          ...
          <div className="p-4">
            <div className="flex flex-wrap gap-2">
              {entityServices?.map(s => (
                <span key={s} className="px-2.5 py-1 bg-gray-100 text-foreground/80 text-[12px] font-semibold rounded-lg">{s.replace('_', ' ')}</span>
              ))}
            </div>
          </div>
        </div>
        ...
        <div className="bg-surface border border-border rounded-[20px] overflow-hidden">
          ...
          <div className="p-4 flex flex-col gap-2 text-[14px]">
            <div className="flex justify-between"><span className="text-muted">Name</span><span className="font-semibold text-right">{entityAdmin?.adminName}</span></div>
            <div className="flex justify-between"><span className="text-muted">Role</span><span className="font-semibold text-right">{entityAdmin?.adminRole}</span></div>
          </div>
        </div>
