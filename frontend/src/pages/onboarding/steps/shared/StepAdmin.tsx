        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="relative">
            ...
            <input 
              ...
              className={`w-full pl-11 pr-4 py-3.5 bg-surface border ${entityErrors?.adminName ? 'border-red-500' : 'border-border focus:border-[#1769E0]'} rounded-2xl outline-none focus:ring-4 transition-all text-[15px] font-medium placeholder:text-muted/70`}
            />
          </div>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="relative">
            ...
            <select 
              ...
              className={`w-full pl-11 pr-4 py-3.5 bg-surface border ${entityErrors?.adminRole ? 'border-red-500' : 'border-border focus:border-[#1769E0]'} rounded-2xl outline-none focus:ring-4 transition-all text-[15px] font-medium text-[#172033] appearance-none`}
            >
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="relative">
            ...
            <input 
              ...
              className={`w-full pl-11 pr-4 py-3.5 bg-surface border ${entityErrors?.adminPhone ? 'border-red-500' : 'border-border focus:border-[#1769E0]'} rounded-2xl outline-none focus:ring-4 transition-all text-[15px] font-medium placeholder:text-muted/70`}
            />
          </div>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="relative">
            ...
            <input 
              ...
              className={`w-full pl-11 pr-4 py-3.5 bg-surface border ${entityErrors?.adminEmail ? 'border-red-500' : 'border-border focus:border-[#1769E0]'} rounded-2xl outline-none focus:ring-4 transition-all text-[15px] font-medium placeholder:text-muted/70`}
            />
          </div>
