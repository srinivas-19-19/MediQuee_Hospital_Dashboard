...
export function ProfileEdit() {
  ...
  return (
    <div className="flex flex-col bg-gray-50/70 min-h-[calc(100vh-80px)] pb-12">
      {/* Sticky Header */}
      <div className="sticky top-0 z-30 bg-white/90 backdrop-blur-md pt-4 pb-3 px-4 border-b border-gray-100 flex items-center justify-between shadow-[0_1px_2px_rgba(0,0,0,0.02)]">
      ...
      <div className="p-4 flex flex-col gap-6 max-w-2xl mx-auto w-full">
        ...
        {!isLoading && error && (
          <div className="p-6 bg-red-50/70 border border-red-200/80 rounded-2xl flex flex-col items-center text-center gap-3">
            ...
            <h3 className="text-base font-bold text-gray-900">Unable to Load Profile</h3>
        ...
        {!isLoading && profile && (
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 flex flex-col gap-4">
              <h3 className="font-bold text-[#0A1A3D] text-sm border-b border-gray-100 pb-2 uppercase tracking-wider">
                Account Information
              </h3>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input 
                  ...
                  className={cn(
                    "bg-gray-50 border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm focus:outline-none focus:ring-2 transition-all", 
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-semibold text-gray-700">Email Address (Managed by System)</label>
                <input 
                  type="email" 
                  value={profile.email} 
                  disabled 
                  className="bg-gray-100 border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm text-gray-500 cursor-not-allowed select-none font-medium" 
                />
                <span className="text-[11px] text-gray-400">Account login email cannot be changed from this screen.</span>
              </div>
              ...
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-semibold text-gray-700 flex items-center gap-1.5">
                    <FileCheck className="w-4 h-4 text-gray-400" /> Medical License Number
                  </label>
                  <input 
                    type="text" 
                    value={licenseNumber}
                    ...
                    className="bg-gray-50 border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm focus:outline-none focus:border-[#1B5DF1] focus:ring-2 focus:ring-[#1B5DF1]/20" 
                  />
                </div>

                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-semibold text-gray-700 flex items-center gap-1.5">
                    <Stethoscope className="w-4 h-4 text-gray-400" /> Primary Specialization
                  </label>
                  <input 
                    type="text" 
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-semibold text-gray-700 flex items-center gap-1.5">
                    <Briefcase className="w-4 h-4 text-gray-400" /> Educational Qualification
                  </label>
                  <input 
                    type="text" 
                    value={qualification}
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-semibold text-gray-700 flex items-center gap-1.5">
                      <Clock className="w-4 h-4 text-gray-400" /> Experience (Years)
                    </label>
                    <input 
                      type="number" 
                      value={experience}
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-semibold text-gray-700 flex items-center gap-1.5">
                      <IndianRupee className="w-4 h-4 text-gray-400" /> Consultation Fee (₹)
                    </label>
                    <input 
                      type="number" 
